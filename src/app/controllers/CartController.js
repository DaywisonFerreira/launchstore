...
module.exports = {
    ...
    async addOne(req, res) {
        ...
        // adicionar o produto ao carrinho (usando o nosso gerenciador de carrinho)
        ...
        // redirecionar o usuário para o tela do carrinho
    ...
    removeOne(req, res) {
        ...
        req.session.cart = cart
        // redirecionamento para a pagina de cart
        return res.redirect('/cart')
    },
    delete(req, res) {
        let { id } = req.params
